...
<view class="question-wrapper">
    <view class="container">
        ...
        <view class="question-choice-wrapper">
            <view class="question-choice" v-for="choice in question.choices" :key="choice.key" @tap="answer(choice.key)">{{choice.title}}</view>
        </view>
    </view>
...
export default defineComponent({
    ...
    setup() {
        ...
        const question = reactive < QustionDomain > ({
            id: "",
            title: "某用户是做服装销售生意的,所有的在线平台和数据都放在阿里云的云服务器 ECS 实例和云数据库 RDS 实例中,现在 CEO 想对销售额的变化趋势做一个监控,并在订单量发生较大变化时能收到预警信息,可以使用阿里云的哪个产品实现,并在管理控制台中展现结果？",
            choices: [{
                    key: "1",
                    title: "态势感知",
                },
